 ...
 * @description
 *
 * Namespace from 'angular-mocks.libs' which contains testing related code.
 *
 */
angular.mock = {};
 ...
 *    `"//ajax.googleapis.com/ajax/libs/angularjs/X.Y.Z/angular-mocks.libs"`
 *  * [NPM](https://www.npmjs.com/) e.g. `npm install angular-mocks@X.Y.Z`
 *  * [Yarn](https://yarnpkg.com) e.g. `yarn add angular-mocks@X.Y.Z`
 *  * [Bower](http://bower.io) e.g. `bower install angular-mocks#X.Y.Z`
 *  * [code.angularjs.org](https://code.angularjs.org/) (discouraged for production use)  e.g.
 *    `"//code.angularjs.org/X.Y.Z/angular-mocks.libs"`
 *
 * where X.Y.Z is the AngularJS version you are running.
 *
 * Then, configure your test runner to load `angular-mocks.libs` after `angular.libs`.
 * This example uses <a href="http://karma-runner.github.io/">Karma</a>:
 *
 * ```
 * config.set({
 *   files: [
 *     'build/angular.libs', // and other module files you need
 *     'build/angular-mocks.libs',
 ...
 * ```
 *
 * Including the `angular-mocks.libs` file automatically adds the `ngMock` module, so your tests
 *  are ready to go!
 */
